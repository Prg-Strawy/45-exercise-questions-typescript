...
// let stripped_name :string = personName2.trim()
...
// guest.forEach(guest=>{if (guest != unable_attend)
...
// function createCountryList (countries : Country[]){
//     return countries;
// }

// const CountryList: Country[]= createCountryList(["Pakistan","Palestine","Japan"]);
...
// function make_shirt1(size:string= "Large", printMsg:string="I love Typescript"){
//     console.log(`You selected ${size} size with ${printMsg} printed on your shirt`);
